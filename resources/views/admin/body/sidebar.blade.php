      ...
      <!-- begin sidebar scrollbar -->
        <div class="sidebar-scrollbar">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                {{-- About Me Page --}}
                <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#aboutme" aria-expanded="false" aria-controls="aboutme">
                        <i class="mdi mdi-image-filter-none"></i>
                        <span class="nav-text">About Me</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="aboutme"
                        ...
                        <div class="sub-menu">                       
                            <li  class="has-sub" >
                                ...
                                <ul  class="collapse"  id="categories">
                                    <div class="sub-menu">                               
                                        <li >
                                            <a href="{{ route('all.category') }}">Languages</a>
                                        </li>
                                        <li >
                                            <a href="{{ route('all.scategory') }}">Frameworks</a>
                                        </li>
                                    </div>
                                </ul>
                            </li>
